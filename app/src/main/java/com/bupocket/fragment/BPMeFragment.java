...
public class BPMeFragment extends BaseFragment{
    ...
    private void initData(View view){
        ...
        TextView nickTextView = view.findViewById(R.id.userNick);
        nickTextView.setText(currentAccNick);

        TextView addressTextView = view.findViewById(R.id.userBcAddress);
        String hideCurrentAccAddress = currentAccAddress.substring(0,10)+"***"+currentAccAddress.substring(currentAccAddress.length()-10,currentAccAddress.length());
        addressTextView.setText(hideCurrentAccAddress);
    }
