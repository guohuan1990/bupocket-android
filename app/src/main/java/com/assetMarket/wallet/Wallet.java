package com.assetMarket.wallet;
...
import com.assetMarket.utils.DecimalCalculate;
import com.assetMarket.wallet.enums.BUChainExceptionEnum;
import com.assetMarket.wallet.enums.ExceptionEnum;
import com.assetMarket.wallet.exception.WalletException;
import com.assetMarket.wallet.model.WalletBPData;
import com.assetMarket.wallet.model.WalletSignData;
import com.assetMarket.wallet.utils.KeyStore;
import com.assetMarket.wallet.utils.keystore.BaseKeyStoreEntity;
import com.assetMarket.wallet.utils.keystore.KeyStoreEntity;
...
public class Wallet {
    ...
    private void init() {
        sdk = SDK.getInstance(com.assetMarket.common.Constants.BUMO_NODE_URL);
    }
    ...
    private WalletBPData create(String password, String sKey, Context context) throws WalletException {
        try {
            ...
            BaseKeyStoreEntity baseKeyStoreEntity =  KeyStore.encryptMsg(password, sKey, com.assetMarket.wallet.Constants.WALLET_STORE_N, com.assetMarket.wallet.Constants.WALLET_STORE_R, com.assetMarket.wallet.Constants.WALLET_STORE_P, 1);
            ...
            for (String pk:privateKeys) {
                keyStoreEntity = KeyStore.generateKeyStore(password, pk, com.assetMarket.wallet.Constants.WALLET_STORE_N, com.assetMarket.wallet.Constants.WALLET_STORE_R, com.assetMarket.wallet.Constants.WALLET_STORE_P, 1);
    ...
    public String getAccountBUBalance(String accountAddress){
        System.out.print(com.assetMarket.common.Constants.BUMO_NODE_URL);
    ...
    private String sendToken(String senderPrivateKey, String issuerAddress,String destAddress ,String code ,String amount,String decimals, String note,String fee) throws Exception {
        ...
        if (!checkAccountActivated(destAddress)) {
            if(Double.parseDouble(fee) - com.assetMarket.common.Constants.ACTIVE_AMOUNT_FEE <= 0){
                throw new WalletException(ExceptionEnum.FEE_NOT_ENOUGH);
            }
            ...
            accountActivateOperation.setInitBalance(ToBaseUnit.BU2MO(com.assetMarket.common.Constants.ACTIVE_AMOUNT_FEE+""));
