...
import com.assetMarket.enums.TokenTypeEnum;
...
//                availableTokenBalance = CommonUtil.rvZeroAndDot(new BigDecimal(AmountUtil.availableSubtractionFee(tokenBalance,Constants.RESERVE_AMOUNT)).setScale(Integer.valueOf(tokenDecimals),BigDecimal.ROUND_HALF_UP).toPlainString());
            }
        }else{
    ...
    private void confirmSendInfo(){
        ...
        mCompleteMnemonicCodeBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (Double.parseDouble(sendAmount) < Constants.MIN_SEND_AMOUNT) {
                    tipDialog = new QMUITipDialog.Builder(getContext())
                ...
                if (Double.parseDouble(sendAmount) > Constants.MAX_SEND_AMOUNT) {
                    tipDialog = new QMUITipDialog.Builder(getContext())
                ...
                if (Double.parseDouble(txFee) < Constants.MIN_FEE) {
                    tipDialog = new QMUITipDialog.Builder(getContext())
