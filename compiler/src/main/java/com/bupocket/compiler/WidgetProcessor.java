...
public class WidgetProcessor extends AbstractProcessor {
    ...
    private final String mPackageName = "com.bupocket.manager";

    ClassName mMapName = ClassName.get("java.util", "Map");
    ClassName mHashMapName = ClassName.get("java.util", "HashMap");
    ClassName mItemDescName = ClassName.get("com.bupocket.model", "QDItemDescription");
    ClassName mBaseFragmentName = ClassName.get("com.bupocket.base", "BaseFragment");
